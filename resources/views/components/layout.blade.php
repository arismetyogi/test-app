          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="/experience" :active="request()->is('jobs')">Experience</x-nav-link>
      ...
      <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            ...
            <div class="ml-3">
              <div class="text-base font-medium leading-none text-white">Arismet</div>
              <div class="text-sm font-medium leading-none text-gray-400">arism@example.com</div>
            </div>
          </div>
        </div>
      </div>
